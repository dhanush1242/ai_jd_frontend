      ...
      appBar: AppBar(
        ...
        title: const Column(
          ...
          children: [
            ...
            SizedBox(height: 4),
            Text('Manage your account preferences and application settings.', style: TextStyle(color: Colors.grey, fontSize: 12)),
          ],
        ),
        actions: [
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _SettingsNavItem(icon: Icons.tune, label: 'Application Preferences', isSelected: _selectedTab == 'Application Preferences', onTap: () => setState(() => _selectedTab = 'Application Preferences')),
                  _SettingsNavItem(icon: Icons.email_outlined, label: 'Email Templates', isSelected: _selectedTab == 'Email Templates', onTap: () => setState(() => _selectedTab = 'Email Templates')),
                          ...
                          children: [
                            const Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 4),
                                Text('Update your personal information and how we can reach you.', style: TextStyle(color: Colors.grey, fontSize: 13)),
                              ],
                            ),
                            ElevatedButton(
                              onPressed: () {},
                          ...
                          child: Row(
                            ...
                            children: [
                              CircleAvatar(
                                ...
                                child: Text(user?.name.isNotEmpty == true ? user!.name[0].toUpperCase() : 'U', style: const TextStyle(fontSize: 32, color: Color(0xFF4F46E5), fontWeight: FontWeight.bold)),
                              ),
                              ...
                              Expanded(
                                child: Column(
                                  children: [
                                    _InfoRow(label: 'Location', value: details?.preferredWorkLocation ?? 'Not provided'),
                                    const SizedBox(height: 16),
                                    _InfoRow(label: 'Current Role', value: (details?.skills?.isNotEmpty == true) ? details!.skills!.split(',').first : 'Not provided'),
                                    const SizedBox(height: 16),
                                    _InfoRow(label: 'Experience', value: '${details?.experience ?? 0} years'),
                                  ],
                                ),
                              ),
                            ],
                        ...
                        Row(
                          ...
                          children: [
                            const Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('Application Preferences', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1E293B))),
                                SizedBox(height: 4),
                                Text('Customize your job search and application experience.', style: TextStyle(color: Colors.grey, fontSize: 13)),
                              ],
                            ),
                            ElevatedButton(
                              onPressed: () {},
                            ...
                            children: [
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    _InfoRow(label: 'Preferred Roles', value: details?.skills ?? 'Not provided', vertical: true),
                                    const SizedBox(height: 24),
                                    _InfoRow(label: 'Preferred Locations', value: details?.preferredWorkLocation ?? 'Not provided', vertical: true),
                                  ],
                                ),
                              ),
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    _InfoRow(label: 'Job Types', value: details?.preferredJobType ?? 'Not provided', vertical: true),
                                    const SizedBox(height: 24),
                                    _InfoRow(label: 'Experience Level', value: '${details?.experience ?? 0} years', vertical: true),
                                  ],
                                ),
                              ),
                            ],
